...
function M.get()
	...
	return {
		...
		TSOperator = { fg = cp.red, style = cnf.styles.operators or {} }, -- For any operator: +, but also -> and * in cp.
		...
		TSNumber = { fg = cp.pink, style = cnf.styles.numbers or {} }, -- For all numbers
		...
		TSConstant = { fg = cp.teal }, -- For constants
