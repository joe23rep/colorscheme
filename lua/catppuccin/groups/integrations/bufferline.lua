...
function M.get()
	...
	return {
		...
		BufferLineBufferSelected = { fg = cp.text, bg = active_bg, style = { "italic" } }, -- current
		-- tabs
		...
		-- separators
		BufferLineSeparator = { fg = cp.mantle, bg = inactive_bg },
		BufferLineSeparatorVisible = { fg = cp.mantle, bg = inactive_bg },
		BufferLineSeparatorSelected = { fg = cp.mantle, bg = active_bg },
		-- close buttons
